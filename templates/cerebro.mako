...
notebook_access_url = ie_request.url_template('${PROXY_URL}/cerebro/')
%>
...
// Load notebook
// This will load code from static/cerebro.js, often used to handle
// things like Login. The load_notebook function will eventually append
// an IFrame to the <div id="main" /> below.
requirejs(['galaxy.interactive_environments', 'plugin/cerebro'], function(IES){
    window.IES = IES
